...
from gacha_item_masters
    left join gacha_product_types on gacha_product_types.id = gacha_item_masters.gacha_product_types_id
    left join gacha_brands on gacha_brands.id = gacha_item_masters.gacha_brands_id
    left join gacha_brand_statuses on gacha_brand_statuses.id = gacha_brands.id
    left join gacha_sku_statuses on gacha_sku_statuses.id = gacha_item_masters.gacha_sku_statuses_id
    left join gacha_categories on gacha_categories.id = gacha_item_masters.gacha_categories_id
