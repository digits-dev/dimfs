<?php namespace App\Http\Controllers;
	...
	class AdminActionTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "action_type";
			$this->limit = "20";
			$this->orderby = "action_type,asc";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Action Type','name'=>'action_type','type'=>'text','validation'=>'required|min:3|max:30}unique:action_types','width'=>'col-sm-6'];
