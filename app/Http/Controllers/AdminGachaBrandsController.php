<?php namespace App\Http\Controllers;
	...
	class AdminGachaBrandsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        $this->col = [];
			$this->col[] = array("label"=>"Brand Description","name"=>"brand_description" );
			$this->col[] = array("label"=>"Brand Status","name"=>"gacha_brand_statuses_id","join"=>"gacha_brand_statuses,id");
			...
			$this->form = [];
			$this->form[] = ["label"=>"Brand Description","name"=>"brand_description","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255",'width'=>'col-sm-5'];
			$this->form[] = ["label"=>"Brand Status","name"=>"gacha_brand_statuses_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"gacha_brand_statuses,id",'width'=>'col-sm-5'];
