<?php namespace App\Http\Controllers;
	...
	class AdminStatusStatesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "status_state";
			$this->limit = "20";
			$this->orderby = "status_state,asc";
			...
			$this->table = "status_states";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Status State","name"=>"status_state"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Status State','name'=>'status_state','type'=>'text','validation'=>'required|alpha_num_spaces|min:3|max:30|unique:status_states','width'=>'col-sm-6'];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					StatusState::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
