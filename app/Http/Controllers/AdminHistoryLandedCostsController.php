<?php namespace App\Http\Controllers;
	...
	class AdminHistoryLandedCostsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "history_landed_costs";
			...
			$this->form[] = ['label'=>'Brand Description','name'=>'brands_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-6','datatable'=>'brands,brand_description'];
			...
			$this->form[] = ['label'=>'Landed Cost','name'=>'landed_cost','type'=>'number','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Working Landed Cost','name'=>'working_landed_cost','type'=>'number','width'=>'col-sm-6'];
