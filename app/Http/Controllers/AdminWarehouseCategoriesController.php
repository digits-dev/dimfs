	...
	class AdminWarehouseCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = [
				...
				'type'=>'text',
				'validation'=>'required|alpha_num|min:3|max:3|unique:warehouse_categories',
				'width'=>'col-sm-6',
				'readonly'=>(CRUDBooster::getCurrentMethod() == "getEdit" && !CRUDBooster::isSuperadmin())?true:false
			];
			$this->form[] = [
				'label'=>'Warehouse Category Description',
				'name'=>'warehouse_category_description',
				'type'=>'text',
				'validation'=>'required|alpha_num_spaces|min:2|max:30|unique:warehouse_categories',
				'width'=>'col-sm-6'
			];
