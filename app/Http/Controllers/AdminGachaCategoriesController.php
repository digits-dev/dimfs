<?php namespace App\Http\Controllers;
	...
	class AdminGachaCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category Description','name'=>'category_description','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-5'];
