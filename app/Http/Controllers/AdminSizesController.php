<?php namespace App\Http\Controllers;
	...
	class AdminSizesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "size_code";
			$this->limit = "20";
			$this->orderby = "size_description,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Size Code","name"=>"size_code"];
			$this->col[] = ["label"=>"Size Description","name"=>"size_description"];
			...
			$this->form[] = [
				...
				'name'=>'size_code',
				'type'=>'text',
				'validation'=>'required|alpha_num|min:1|max:3|unique:sizes',
				'width'=>'col-sm-6',
			...
			$this->form[] = [
				...
				'type'=>'text',
				'validation'=>'required|alpha_num_spaces|min:3|max:30|unique:sizes',
				'width'=>'col-sm-6'
			];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					Size::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
	    ...
	    */
		...
		public function getSizeCode($id) {
			if(is_numeric($id)) return Size::where('id', $id)->value('size_code');
		}
	}