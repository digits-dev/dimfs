<?php namespace App\Http\Controllers;
	...
	class AdminCurrenciesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "currency_code";
			$this->limit = "20";
			$this->orderby = "currency_description,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Currency Code","name"=>"currency_code"];
			$this->col[] = ["label"=>"Currency Description","name"=>"currency_description"];
			...
			$this->form[] = [
				...
				'name'=>'currency_code',
				'type'=>'text',
				'validation'=>'required|alpha_num|min:3|max:3|unique:currencies',
				'width'=>'col-sm-6',
			...
			$this->form[] = [
				...
				'type'=>'text',
				'validation'=>'required|alpha_num_spaces|min:3|max:30|unique:currencies',
				'width'=>'col-sm-6'
			];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					Currency::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
