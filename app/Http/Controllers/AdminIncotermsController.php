<?php namespace App\Http\Controllers;
	...
	class AdminIncotermsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "incoterms_code";
			$this->limit = "20";
			$this->orderby = "incoterms_description,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Incoterms Code","name"=>"incoterms_code"];
			$this->col[] = ["label"=>"Incoterms Description","name"=>"incoterms_description"];
			...
			$this->form[] = [
				...
				'name'=>'incoterms_code',
				'type'=>'text',
				'validation'=>'required|alpha_num|min:3|max:3|unique:incoterms',
				'width'=>'col-sm-6',
			...
			$this->form[] = [
				...
				'type'=>'text',
				'validation'=>'required|alpha_num_spaces|min:3|max:30|unique:incoterms',
				'width'=>'col-sm-6'
			];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					Incoterm::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
