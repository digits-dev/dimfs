<?php namespace App\Http\Controllers;
	...
	class AdminGachaInventoryTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "inventory_type_description";
			$this->limit = "20";
			...
			$this->table = "gacha_inventory_types";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Inventory Type Description','name'=>'inventory_type_description','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-5'];
