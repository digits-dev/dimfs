<?php namespace App\Http\Controllers;
	...
	class AdminGachaWhCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "gacha_wh_categories";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"WH Category Description","name"=>"category_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'WH Category Description','name'=>'category_description','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-5'];
