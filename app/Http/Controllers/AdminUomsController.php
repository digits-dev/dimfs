<?php namespace App\Http\Controllers;
	...
	class AdminUomsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'UOM Code','name'=>'uom_code','type'=>'text','validation'=>'required|alpha_num|min:3|max:3|unique:uoms','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'UOM Description','name'=>'uom_description','type'=>'text','validation'=>'required|alpha_num_spaces|min:3|max:30|unique:uoms','width'=>'col-sm-6'];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					Uom::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
