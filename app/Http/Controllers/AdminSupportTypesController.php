<?php namespace App\Http\Controllers;
	...
	class AdminSupportTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "support_type_description";
			$this->limit = "20";
			$this->orderby = "support_type_description,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Support Type Description","name"=>"support_type_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Support Type Description','name'=>'support_type_description','type'=>'text','validation'=>'required|min:3|max:50','width'=>'col-sm-6'];
