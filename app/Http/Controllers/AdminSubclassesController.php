<?php namespace App\Http\Controllers;
	...
	class AdminSubclassesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = [
				...
				'width'=>'col-sm-6',
				'datatable'=>'classes,class_description','datatable_where'=>"status='ACTIVE'"
			];
			$this->form[] = [
				'label'=>'Subclass Description',
				'name'=>'subclass_description',
				'type'=>'text',
				'validation'=>'required|alpha_num_spaces|min:3|max:50|unique:subclasses',
				'width'=>'col-sm-6'
			];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/subclass_submaster.js");
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					Subclass::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        //Your code here
	        $postdata["subclass_code"]=self::generateSubclassCode();
	    ...
	    */
	    public function hook_after_add($id) {        
	        //Your code here
            if(CRUDBooster::isSuperadmin() || CRUDBooster::myPrivilegeName() == "ADMIN"){
	            return redirect()->action('AdminMarginCategoriesController@getAdd')->send();
				exit;
	        }
	    }
	    ...
	    */
        ...
        public function generateSubclassCode(){
		...
		public function getSubclassByClass($class_id) {
			if(is_numeric($class_id)){
				return Subclass::where('subclasses.classes_id', $class_id)
