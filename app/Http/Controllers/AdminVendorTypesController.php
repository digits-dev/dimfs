<?php namespace App\Http\Controllers;
	...
	class AdminVendorTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->limit = "20";
			$this->orderby = "vendor_type_description,asc";
			...
			$this->form[] = [
				...
				'type'=>'text',
				'validation'=>'required|alpha_num|min:3|max:15|unique:vendor_types',
				'width'=>'col-sm-6',
			...
			$this->form[] = [
				...
				'type'=>'text',
				'validation'=>'required|alpha_num_spaces|min:3|max:30|unique:vendor_types',
				'width'=>'col-sm-6'
			];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					VendorType::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
