<?php namespace App\Http\Controllers;
	...
	class AdminGachaSkuStatusesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "status_description";
			$this->limit = "20";
			$this->orderby = "status_description,asc";
