<?php namespace App\Http\Controllers;
	...
	class AdminRmaCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "category_code";
			$this->limit = "20";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category Code','name'=>'category_code','type'=>'text','validation'=>'required|min:3|max:3','width'=>'col-sm-6','readonly'=>(CRUDBooster::getCurrentMethod() == "getEdit" && !CRUDBooster::isSuperadmin())?true:false];
			$this->form[] = ['label'=>'Category Description','name'=>'category_description','type'=>'text','validation'=>'required|min:3|max:30|unique:rma_categories','width'=>'col-sm-6'];
	    ...
	    */
        ...
        public function getRMACategoryCode($id){
            if(is_numeric($id)) return RmaCategory::where('id', $id)->value('category_code');
        }
	}