<?php namespace App\Http\Controllers;
	...
	class AdminSkuStatusesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = [
				'label'=>'SKU Status Code',
				'name'=>'sku_status_code',
				'type'=>'text',
				'validation'=>'required|alpha_num|min:3|max:3|unique:sku_statuses',
				'width'=>'col-sm-6',
				'readonly'=>(CRUDBooster::getCurrentMethod() == "getEdit" && !CRUDBooster::isSuperadmin())?true:false
			];
			$this->form[] = [
				'label'=>'SKU Status Description',
				'name'=>'sku_status_description',
				'type'=>'text',
				'validation'=>'required|alpha_num_spaces|min:3|max:30|unique:sku_statuses',
				'width'=>'col-sm-6'
			];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					SkuStatus::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
