<?php namespace App\Http\Controllers;
	...
	class AdminSkuClassesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "sku_class_description";
			$this->limit = "20";
			$this->orderby = "sku_class_description,asc";
			...
			$this->table = "sku_classes";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"SKU Class Description","name"=>"sku_class_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'SKU Class Description','name'=>'sku_class_description','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
