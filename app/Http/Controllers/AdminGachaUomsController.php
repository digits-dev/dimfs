<?php namespace App\Http\Controllers;
	...
	class AdminGachaUomsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Uom Code','name'=>'uom_code','type'=>'text','validation'=>'required|min:1|max:3','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Uom Description','name'=>'uom_description','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-5'];
