<?php 
	...
	class AdminSegmentationLegendsController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "segment_legend_description";
			$this->limit = "20";
			$this->orderby = "segment_legend_description,asc";
			...
			$this->table = "segmentation_legends";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Segment Legend Description","name"=>"segment_legend_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Segment Legend Description','name'=>'segment_legend_description','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-6'];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					SegmentationLegend::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
