<?php namespace App\Http\Controllers;
	...
	class AdminGachaVendorTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "vendor_type_code";
			$this->limit = "20";
			$this->orderby = "vendor_type_code,asc";
			...
			$this->table = "gacha_vendor_types";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Vendor Type Code","name"=>"vendor_type_code"];
			$this->col[] = ["label"=>"Vendor Type Description","name"=>"vendor_type_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Vendor Type Code','name'=>'vendor_type_code','type'=>'text','validation'=>'required|min:1|max:10','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Vendor Type Description','name'=>'vendor_type_description','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-5'];
