<?php namespace App\Http\Controllers;
	...
	class AdminHistoryUpcCodesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Upc Code','name'=>'upc_code','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
