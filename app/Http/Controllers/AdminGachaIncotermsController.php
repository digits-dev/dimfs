<?php namespace App\Http\Controllers;
	...
	class AdminGachaIncotermsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "incoterm_description";
			$this->limit = "20";
			$this->orderby = "incoterm_description,asc";
			...
			$this->table = "gacha_incoterms";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Incoterm Description","name"=>"incoterm_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Incoterm Description','name'=>'incoterm_description','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-5'];
