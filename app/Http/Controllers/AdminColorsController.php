<?php namespace App\Http\Controllers;
	...
	class AdminColorsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "color_code";
			$this->limit = "20";
			$this->orderby = "color_description,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Main Color Code","name"=>"color_code"];
			$this->col[] = ["label"=>"Main Color Description","name"=>"color_description"];
			...
			$this->form = [];
			$this->form[] = [
				'label'=>'Main Color Code',
				'name'=>'color_code',
				'type'=>'text',
				'validation'=>'required|alpha_num|min:3|max:3|unique:colors',
				'width'=>'col-sm-6',
				'help'=>'Color Code must be 3 letter unique code format. (Example: ABC)',
			...
			$this->form[] = [
				...
				'type'=>'text',
				'validation'=>'required|alpha_num_spaces|min:2|max:30|unique:colors',
				'width'=>'col-sm-6'
			];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        switch ($button_name) {
				case 'set_status_ACTIVE':
					...
					Color::whereIn('id',$id_selected)->update([
						'status'=>'ACTIVE', 
