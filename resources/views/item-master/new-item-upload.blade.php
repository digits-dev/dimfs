...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload.item') }}">
        ...
        <div class="box-body">
            ...
            <div class='callout callout-success'>
                ...
                1. All records for uploading should have corresponding values/entries in all submasters.<br/>
                2. If "size" is N/A put size = 0 and size code = N/A<br/>
                3. Please put 0 on serial code, imei code1 and imei code2<br/>
                4. File format should be : CSV file format<br/>
            </div>

            <label class='col-sm-2 control-label'>Import Template File: </label>
            <div class='col-sm-4'>
                <a href="{{ route('upload.item-template') }}" class="btn btn-primary" role="button">Download Template</a>
            </div>
            <br/>
            <br/>
