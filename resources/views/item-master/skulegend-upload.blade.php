    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload.skulegend') }}">
        ...
        <div class="box-body">
            ...
            <div class='callout callout-success'>
                ...
                1. System will not accept wrong Digits Code or SKU Legend<br/>
            ...
            <div class='col-sm-4'>
                <a href="{{ route('upload.skulegend-template') }}" class="btn btn-primary" role="button">Download Template</a>
            </div>
            <br/>
            <br/>
