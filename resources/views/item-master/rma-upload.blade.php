...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload.rma') }}">
        ...
        <div class="box-body">
            ...
            <div class='col-sm-4'>
                <a href="{{ route('upload.rma-template') }}" class="btn btn-primary" role="button">Download Template</a>
            </div>
            <br />
            <br />
