...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload.wrr') }}">
        ...
        <div class="box-body">
            ...
            <div class='callout callout-success'>
                ...
                1. Date format should be yyyy-mm-dd (Eg. 2020-10-03)<br/>
                2. Dates must be sorted from OLD to NEW<br/>
                3. Uploading of Digits Code can be multiple per file (System will get earliest date for Initial WRR, and get latest date for Latest WRR)<br/>
                4. System will not accept wrong Digits Code or Date<br/>
                5. System will not accept blank<br/>
                6. File format should be : CSV file format<br/>
            </div>

            <label class='col-sm-2 control-label'>Import Template File: </label>
            <div class='col-sm-4'>
                <a href="{{ route('upload.wrr-template') }}" class="btn btn-primary" role="button">Download Template</a>
            </div>
            <br/>
            <br/>
