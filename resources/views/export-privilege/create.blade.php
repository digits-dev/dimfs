...
<div class="box">
    <div class="panel panel-default">
        <div class="panel-heading text-center">
            User Export Privilege Creation
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="modules" id="modules" class="form-control" required>
                            ...
                            @foreach ($modules as $module)
                                <option value="{{ $module->id }}" data-table="{{ $module->table_name }}">{{ Illuminate\Support\Str::upper($module->name) }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="action_types" id="action_types" class="form-control" required>
                            ...
                            @foreach ($actionTypes as $action)
                                <option value="{{ $action->id }}">{{ Illuminate\Support\Str::upper($action->action_type) }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="cms_privileges" id="cms_privileges" class="form-control" required>
                            ...
                            @foreach ($privileges as $privilege)
                                <option value="{{ $privilege->id }}">{{ Illuminate\Support\Str::upper($privilege->name) }}</option>
                            @endforeach
                        </select>
                    </div>
