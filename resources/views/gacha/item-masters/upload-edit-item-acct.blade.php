...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('edit.gachaItems') }}">
        ...
        <div class="box-body">
            ...
            <div class='callout callout-success'>
                ...
                1. If one of the ff needs to be updated e.g. (LC per Carton, LC per PC) LC PER CARTON, LC PER PC can't be null/blank. <br/>
                2. File format should be : CSV file format<br/>
            </div>

            <label class='col-sm-2 control-label'>Import Template File: </label>
            <div class='col-sm-4'>
                <a href="{{ route('edit.gacha-template') }}" class="btn btn-primary" role="button">Download Template</a>
            </div>
            <br/>
            <br/>
