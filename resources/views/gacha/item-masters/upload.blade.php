...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload.gachaItems') }}">
        ...
        <div class="box-body">
            ...
            <div class='callout callout-success'>
                ...
                2. If one of the ff needs to be updated e.g. (brand, wh category) BRAND, WH CATEGORY can't be null/blank. <br/>
                3. Upload limit up to 1,000 records per upload session.<br/>
                4. File format should be : CSV file format<br/>
            </div>

            <label class='col-sm-2 control-label'>Import Template File: </label>
            <div class='col-sm-4'>
                <a href="{{ route('upload.gacha-template') }}" class="btn btn-primary" role="button">Download Template</a>
            </div>
            <br/>
            <br/>
