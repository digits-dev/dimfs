...
return [
    ...
    'page_not_found_tips' => '* Please make sure the URL is correct<br/>
                * Maybe the page that you are looking for has been deleted by System Administrator<br/>
                * Please use the back button of the browser<br/>',
    'try_log_login' => ':email tried to login with IP :ip',
    'log_try_login' => ':email tried to login with IP :ip',
    ...
    'alert_add_item_success' => 'The data with digits code :item_code has been added !',
    ...
    'alert_user_doesnt_exist' => 'Failed! User doesn\'t exist.',
    ...
    'button_export' => 'Export Filtered',
    'button_filter' => '',
    'button_close' => 'Close',
    'button_submit' => 'Submit',
    'button_logout' => 'Logout',
    'button_sign_in' => 'Login',
    'button_selected_action' => '',
    ...
    "notice_delete_file_upload" => "* If you want to upload other file, please delete the file first.",
